...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\django checkbook\checkbook'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\django checkbook\checkbook\Scripts\deactivate.nu'
