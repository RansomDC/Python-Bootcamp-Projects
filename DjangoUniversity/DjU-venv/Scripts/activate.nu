...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\DjangoUniversity\DjU-venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\DjangoUniversity\DjU-venv\Scripts\deactivate.nu'
