...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\django-challenge\Hello_World'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Ranso\Documents\Programming\Python-Bootcamp-Projects\django-challenge\Hello_World\Scripts\deactivate.nu'
